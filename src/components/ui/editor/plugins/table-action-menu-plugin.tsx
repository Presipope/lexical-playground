  ...
  return createPortal(
    ...
    >
      ...
      >
        ...
        {backgroundColor && (
          <span
            className="ml-auto w-4 h-4 rounded border border-border"
      ...
      <button
        type="button"
        className="table-action-menu-item"
        onClick={() => setShowVerticalAlign(!showVerticalAlign)}
      >
      ...
      >
        ...
        <span>Toggle first row freeze</span>
      </button>
      <button
        type="button"
        className="table-action-menu-item"
      ...
      >
        ...
        <span>Toggle first column freeze</span>
      </button>
      ...
      <button
        type="button"
        className="table-action-menu-item text-destructive"
      ...
      >
        ...
        <span>{isRowHeader ? 'Remove' : 'Add'} row header</span>
      </button>
      <button
        type="button"
        className="table-action-menu-item"
      ...
      >
        <TableProperties className="h-4 w-4 mr-2 rotate-90" />
        <span>{isColumnHeader ? 'Remove' : 'Add'} column header</span>
      </button>
    </div>,
    document.body
  )
  ...
  const checkTableCellOverflow = useCallback(
    (tableCellParentNodeDOM: HTMLElement): boolean => {
      const scrollableContainer = tableCellParentNodeDOM.closest(
        '.tableScrollableWrapper, [class*="tableScrollableWrapper"]'
      )
